...
class LoseState extends FlxState
{
	...
	override public function create():Void
	{
		...
		Reg.text = new FlxText(10,40,620,"You Lost!");
		Reg.text.size = 72;
		add(Reg.text); 
		Reg.text.alignment = "center";
		
		Reg.text = new FlxText(10,130,620,"You fought valiantly. Sadly, your best efforts were not enough to overcome the dangers presented to you. Your bones lay in a heap in the tunnels as future warriors try their hand at saving the world.");
		Reg.text.size = 24;
		Reg.text.alignment = "center";
		add(Reg.text); 
